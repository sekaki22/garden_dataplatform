...
st.sidebar.success("Select a sensor for more information")# Add a select box to the sidebar for sensor selection
sensor_options = ["DHT 22", "TSL 2591", "Soil Moisture sensor", "Battery usage"]
selected_sensor = st.sidebar.selectbox(
    "Select a sensor to for more information",
